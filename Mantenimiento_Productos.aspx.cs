...
public partial class Mantenimiento_Articulos : System.Web.UI.Page
{
    ...
    public void Listar_Modelos(string MarcaSeleccionada)
    {
        Global.CN.Open();
        SqlDataReader Lector;
        ...
        CMDModelo.Parameters.AddWithValue("@Marca", MarcaSeleccionada);
    ...
    {
        //Limpiar los Valores de Control :DDL_Categoria
        this.DDL_Genero.Items.Clear();

        //Agregar un primer elemento al control: DDL_Categoria 
        this.DDL_Genero.Items.Add("--Seleccione--");
        this.DDL_Genero.Items.Add("Masculino");
        this.DDL_Genero.Items.Add("Femenino");
        this.DDL_Genero.Items.Add("Unisex");
    }
    public void Nuevo()
    {
    ...
    public void Guardar(string Tipo_Transaccion)
    {
        ...
        ParamGenero.SqlDbType = SqlDbType.VarChar;
        ParamGenero.Size = 15;
        ParamGenero.Value = this.DDL_Genero.SelectedValue;
        ...
        CMDGuardar.Parameters.Add(ParamGenero);
